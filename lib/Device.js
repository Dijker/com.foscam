...
class Device extends Homey.Device {
    ...
    async sendCommand (cmd, options)
    {
        ...
        return await this._api.get(cmd, options)
            .catch( err => {
                this.error('=================== ERROR ===================');
                this.error('Command :', cmd);
                this.error('Model   :', settings.product_name);
                this.error('Hardware:', settings.hardware_version);
                this.error('Firmware:', settings.firmware_version);

...
class Api {
    ...
    async checkMotionCommand (device_data) {
        return this._httpRequest(device_data, 'getMotionDetectConfig', false, null, false);
    }
    ...
    */
    ...
    async _httpRequest (device_data, command, raw, params, report_error) {
        ...
        // Report error is optional
        if (typeof report_error === 'undefined') {
            report_error = true;
        }
    ...
    |---------------------------------------------------------------------------
    |
    | This method is used to validate the HTTP response from the camera API.
    |
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This method is used to check if the API response is valid.
    |
    */
